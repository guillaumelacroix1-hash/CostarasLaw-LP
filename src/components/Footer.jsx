                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="border-t border-white/10 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                        ...
                        <div className="flex space-x-6 mt-4 md:mt-0">
                            <Link className="hover:text-white transition-colors" to="/privacy-policy" onClick={() => window.scrollTo(0, 0)}>Privacy Policy</Link>
                            <Link className="hover:text-white transition-colors" to="/terms-of-service" onClick={() => window.scrollTo(0, 0)}>Terms of Service</Link>
                        </div>
                    </div>
                </div>
            </div>
